...
rake_names = [
    ...
    # Add all the remaining rake names here...
]

# Your FOIS session cookie
...
def fetch_rr_numbers_fois(rake_names, session_cookie, output_file="rake_rr_numbers.xlsx"):
    ...
    with sync_playwright() as p:
        # Headless=True for Codespaces, headless=False to see actions locally
